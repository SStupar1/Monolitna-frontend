...
export class AdCardComponent implements OnInit {
  ...
  @Input() ad: any;
  @Input() actionType: string; //u zavisnosti od ovog parametra renderujemo akcije u card komponenti
  private user: any;
  ...
  public updateAd(id){
    this.router.navigateByUrl(`home-page/updates/update-ad/${id}`);
  }
  ...
  public moreDetails(id){
    ...
    this.router.navigateByUrl(`home-page/ad-details`);
  }
}
